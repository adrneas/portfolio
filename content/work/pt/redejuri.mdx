...
<figure className="case-figure case-figure--wide case-figure--crop">
  ...
  <figcaption>A busca reuniu comparação de profissionais e disponibilidade no mesmo ponto de decisão, reduzindo a alternância entre perfil, agenda e checkout.</figcaption>
</figure>
...
<figure className="case-figure case-figure--pair">
  ...
  <figcaption>O detalhamento e o pagamento aparecem depois da escolha principal, mantendo o início do funil mais leve e mais orientado à decisão.</figcaption>
</figure>
...
<figure className="case-figure case-figure--pair">
  ...
  <figcaption>Mensagens, documentos e profissionais salvos dão continuidade à relação depois do agendamento, sem transformar a área privada em um painel pesado.</figcaption>
</figure>
...
<figure className="case-figure case-figure--pair">
  ...
  <figcaption>Perfil, avaliações e clientes reforçam confiança e dão ao profissional um ambiente de acompanhamento além da captação inicial.</figcaption>
</figure>
...
<figure className="case-figure case-figure--wide">
  ...
  <figcaption>A área financeira fecha a jornada operacional, conectando consulta, pagamento e histórico em uma superfície simples de conferir.</figcaption>
</figure>
