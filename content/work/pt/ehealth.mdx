...
<figure className="case-figure case-figure--wide">
  <img src="/work/ehealth/mapa-de-funcionalidades.svg" alt="Mapa de funcionalidades do eHealth, estruturando módulos e etapas anteriores ao layout final." />
  <figcaption>O mapa de funcionalidades serviu como ponte entre pesquisa e interface: alinhou escopo, priorização e dependências antes da etapa visual.</figcaption>
</figure>
