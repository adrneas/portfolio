...
<figure className="case-figure case-figure--pair">
  ...
  <figcaption>Details and payment come after the main choice, keeping the beginning of the funnel lighter and more decision-oriented.</figcaption>
</figure>
...
<figure className="case-figure case-figure--pair">
  ...
  <figcaption>Messages, documents, and saved professionals continue the relationship after booking without turning the private area into a heavy admin panel.</figcaption>
</figure>
...
<figure className="case-figure case-figure--pair">
  ...
  <figcaption>Profile, reviews, and clients reinforce trust and give professionals a follow-up environment beyond initial acquisition.</figcaption>
</figure>

<figure className="case-figure case-figure--wide">
  <img src="/work/redejuri/ADVOGADO/Pagamentos.svg" alt="Lawyer payments screen with financial values and payment history." />
  <figcaption>The financial area closes the operational journey, connecting consultation, payment, and history in a simple surface to review.</figcaption>
</figure>
