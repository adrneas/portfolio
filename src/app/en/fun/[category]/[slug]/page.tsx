...
import { getCollectionFromFunCategory, isFunCategory } from "@/lib/i18n";
...
export function generateStaticParams() {
  return getFunEntryStaticParams("en");
}
...
export async function generateMetadata({
  ...
  return entryMetadata("en", collection, slug);
}
...
export default async function Page({ params }: PageProps) {
  ...
  return <EntryView collection={collection} locale="en" slug={slug} />;
}
